		...
		<div id="wrapper" class="container">
            ...
            <div class="register-title">Todos os campos são obrigatórios</div>
           	...
           	<form id="form-register" name="form-register" method="post" autocomplete="off" >
           		<input type="text" class="input-big" id="email" name="email" class="tooltip_link" maxlength="40" value="${user.email}" placeholder="E-mail" /> <br />
                ...
                <input type="password" class="input-big" id="password" name="password" maxlength="10" value="" placeholder="Senha" /> <br />
