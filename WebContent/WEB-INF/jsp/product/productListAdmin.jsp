...
<html lang="pt-BR">
    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<h4 class="title">
               	<span class="pull-left"><span class="text"><span class="line">Listagem de Produtos para <strong>Edição</strong></span></span></span>
            </h4>
											...
											<c:forEach items="${products}" var="product" >
												...
												<li class="span3">
													<div class="product-box">
														...
														<a class="btn btn-warning" href="/produtos/editar/${product.id}">Editar</a>
													</div>
												</li>
											</c:forEach>
										</ul>
